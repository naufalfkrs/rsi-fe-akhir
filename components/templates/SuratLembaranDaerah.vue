<template>
  <div class="text-black m-4 h-[297mm] w-[210mm] overflow-hidden rounded-md bg-white pt-2 shadow-lg print:m-0 print:h-screen print:w-screen print:rounded-none print:shadow-none mx-auto py-2 border border-gray-300">
    ...
    <h2 class="text-center text-xl font-arial mt-8 ml-[1cm]">LEMBARAN DAERAH</h2>
    <p class="text-center ml-[1cm] text-xl font-arial">{{ formData?.Lembaran_daerah || '..........................' }}</p>

    <div class="flex justify-between ml-[3cm] mr-[2cm] mt-10">
      <p class="text-xl font-arial">Nomor {{ formData?.Nomor_tahun || '......' }} Tahun {{ formData?.Tahun || '......' }}</p>
      <p class="text-xl font-arial">Seri {{ formData?.Seri || '......' }} Nomor {{ formData?.Nomor_seri || '......' }}</p>
    </div>

    <h2 class="text-center text-xl font-arial mt-16 ml-[1cm]">PERATURAN DAERAH</h2>
    <p class="text-center ml-[1cm] text-xl font-arial mt-2">{{ formData?.Peraturan_daerah || '..........................' }}</p>
    <p class="text-center ml-[1cm] text-xl font-arial my-4">Nomor: {{ formData?.Nomor_surat || '...............' }}</p>
    <h2 class="text-center text-xl font-arial ml-[1cm] mt-2">TENTANG</h2>
    ...
    <h2 class="text-xl font-arial mt-10 ml-[3cm]">Diundang dalam lembaran daerah</h2>

    <div class="ml-[3cm] space-y-1 mt-2">
      <p class="text-xl font-arial text-justify w-56">
        {{ formData?.Lembaran_daerah_1 || '...........................................' }} Nomor {{ formData?.Nomor_1 || '........' }} Tahun {{ formData?.Tahun || '........' }} Seri
        {{ formData?.Seri || '................................' }} Tanggal {{ formData?.Tanggal || '.........................' }}
      </p>
    </div>
